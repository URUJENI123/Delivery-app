            ...
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="flex items-center gap-3 px-4 h-[76px] border-b border-gray-150 last:border-b-0">
                ...
                <div className="flex-1 space-y-1.5">
                  ...
                  <div className="h-3 w-36 bg-gray-100 rounded-md relative overflow-hidden after:absolute after:inset-0 after:bg-gradient-to-r after:from-transparent after:via-white/60 after:to-transparent after:animate-shimmer after:bg-[length:200%_100%]" />
        ...
        {conversations.length === 0 ? (
          <div className="flex flex-col items-center py-16 text-center">
            ...
            <p className="font-body text-sm text-gray-400 mt-2 max-w-[240px]">
              Your messages with senders will appear here
            </p>
          </div>
        ) : (
          <div className="bg-bg-card border border-gray-200 rounded-xl overflow-hidden">
