      ...
      >
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.actionButton} onPress={handleTakePhoto}>
            ...
            <Text style={styles.actionButtonText}>
              {selfieUri ? 'RETAKE PHOTO' : 'TAKE PHOTO'}
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.card}>
          <TouchableOpacity
            ...
            onPress={() => handleUpload('nationalId')}
          >
            {nationalIdUri ? (
              <Image source={{ uri: nationalIdUri }} style={styles.previewImage} />
            ) : (
              <View style={styles.docIconWrap}>
                <Ionicons name="id-card-outline" size={36} color={colors.onSurfaceVariant} />
              </View>
            )}
          </TouchableOpacity>
          <Text style={styles.cardLabel}>NATIONAL ID FRONT</Text>
          <TouchableOpacity
            style={[styles.uploadButton, nationalIdUri ? styles.uploadButtonDone : undefined]}
            onPress={() => handleUpload('nationalId')}
          >
            <Ionicons
              name={nationalIdUri ? 'checkmark-circle-outline' : 'cloud-upload-outline'}
              size={16}
              color={nationalIdUri ? SUCCESS_COLOR : colors.primary}
            />
            <Text style={[styles.uploadButtonText, nationalIdUri ? styles.uploadButtonTextDone : undefined]}>
              {nationalIdUri ? 'CHANGE' : 'UPLOAD IMAGE'}
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.card}>
          ...
          >
            {licenseUri ? (
              ...
              <View style={styles.docIconWrap}>
                <Ionicons name="card-outline" size={36} color={colors.onSurfaceVariant} />
              </View>
            )}
          </TouchableOpacity>
          <Text style={styles.cardLabel}>DRIVER'S LICENSE</Text>
          <TouchableOpacity
            style={[styles.uploadButton, licenseUri ? styles.uploadButtonDone : undefined]}
            onPress={() => handleUpload('license')}
          >
            <Ionicons
              name={licenseUri ? 'checkmark-circle-outline' : 'cloud-upload-outline'}
              size={16}
              color={licenseUri ? SUCCESS_COLOR : colors.primary}
            />
            <Text style={[styles.uploadButtonText, licenseUri ? styles.uploadButtonTextDone : undefined]}>
              {licenseUri ? 'CHANGE' : 'UPLOAD IMAGE'}
            </Text>
          </TouchableOpacity>
        </View>
